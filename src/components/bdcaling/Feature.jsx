    ...
    return (
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 bg-black">
              <div className="mb-14 text-center">
                  <h2 className="text-4xl text-center font-bold text-white leading-[3.25rem] mb-6 max-w-max lg:max-w-3xl lg:mx-auto">Elevate Your Business with Custom AI Automation Solutions</h2>
                  <p className="text-base font-normal text-white lg:max-w-2xl lg:mx-auto mb-8">Using technology to make finance business, smarter and more rewarding. </p>  
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-lg mx-auto md:max-w-2xl lg:max-w-full">
                  <div className="relative w-full h-auto md:col-span-2">
                      <div className="bg-gray-800 rounded-2xl flex  justify-between flex-row flex-wrap">
                          <div className="p-5  xl:p-8 w-full md:w-1/2 ">
                              ...
                              <button className="py-2 px-5 border border-solid border-gray-300 rounded-full gap-2 text-xs text-white font-semibold flex items-center justify-between transition-all duration-500 hover:bg-black/5">
                                  View More
                  ...
                  <div className="relative w-full h-auto">
                      <div className="bg-indigo-500 rounded-2xl p-5  xl:p-8 h-full">
                          ...
                          <h3 className="py-5 text-black text-lg font-bold xl:text-xl">Improved technology yields greater value</h3>
                          <p className="text-xs font-normal text-black mb-8">We’ve eliminated old analogue process with state-of-the art tech </p>
                          <button className="py-2 px-5 border border-solid border-gray-300 rounded-full gap-2 text-xs text-black font-semibold flex items-center justify-between transition-all duration-500 hover:bg-black/5">
                              View More
                              <svg width="6" height="10" viewBox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path d="M1 9L3.58579 6.41421C4.25245 5.74755 4.58579 5.41421 4.58579 5C4.58579 4.58579 4.25245 4.25245 3.58579 3.58579L1 1" stroke="white" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"></path>
                                  </svg>
                  ...
                  <div className="relative w-full h-auto">
                      <div className="bg-violet-500 rounded-2xl p-5 xl:p-8 h-full">
                          ...
                          <h3 className="py-5 text-black text-lg font-bold xl:text-xl">Build wealth with insurance planning</h3>
                          <p className="text-xs font-normal text-black mb-8">Every life plan policy has a built-in wealth bonus, and we contribute too    </p>
                          <button className="py-2 px-5 border border-solid border-gray-300 rounded-full gap-2 text-xs text-black font-semibold flex items-center justify-between transition-all duration-500 hover:bg-black/5">
                              View More
                              <svg width="6" height="10" viewBox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path d="M1 9L3.58579 6.41421C4.25245 5.74755 4.58579 5.41421 4.58579 5C4.58579 4.58579 4.25245 4.25245 3.58579 3.58579L1 1" stroke="white" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"></path>
