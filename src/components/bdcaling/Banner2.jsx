...
const Banner2 = () => {
    return (
        <div 
        class="bg-gradient-to-b from-[#101212] relative to-[#08201D]"
        ...
        <section class="relative lg:min-h-[1000px] pt-24 pb-10 sm:pt-32 sm:pb-16 lg:pb-24">
            ...
            <div class="absolute inset-x-0 bottom-0 z-10 hidden lg:flex">
                ...
                {/* <Image placeholder='blur' blurDataURL='/img1.jpg'
             priority src='/img2.jpg' height={300} width={300} alt='next-level-services' />
                <Image placeholder='blur' blurDataURL='/logo.png'
             priority src='/img3.jpg' height={300} width={300} alt='next-level-services' /> */}
            ...
            <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative z-20">
                <div class="max-w-xl mx-auto text-center">
                    <h1 class="text-4xl font-bold sm:text-6xl">
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-white"> Transform Your Business with Intelligent Document Processing and Automation</span>
                    </h1>
                    <p class="mt-5 text-base text-white sm:text-xl">Streamline workflows, unlock data insights, and boost efficiency with our Microsoft 365, Azure AI, and Power Platform solutions.</p>
    
                    <span href="#" title="" class="inline-flex items-center px-6 py-4 mt-8 font-semibold text-white transition-all duration-200 bg-blue-600 rounded-lg sm:mt-16 hover:bg-blue-700 focus:bg-blue-700" role="button">
                        Apply for free
